...
class lvl1{
    constructor(){
        ...
        this.p1 = new Platform(displayWidth / 4.266, 745, 730, 100)
        this.p2 = new Platform(1090 * this.w / 1920, 745, 160, 100)
        this.p3 = new Platform(1090, 720, 155, 150)
        this.p4 = new Platform(1250, 720, 35, 150)
        this.p5 = new Platform(1555, 720, 465, 150)
        this.p6 = new Platform(1865, 720, 35, 150)
        this.p7 = new Platform(2020, this.h / 1.28, 140, 40)
        this.p8 = new Platform(2210, this.h / 1.28, 140, 40)
        this.p9 = new Platform(2355, 720, 35, 150)
        ...
        this.ob1 = createSprite(760, 760, 50, 50)
        ...
        this.lSprite = createButton("")
        this.lSprite.size(70, 50)
        this.lSprite.position(this.w / 2.5, this.h / 1.55)
        // this.lSprite.hide()
        this.rSprite = createSprite(this.w / 1.7, this.h / 1.55, 70, 50)
        // this.lSprite.visible = false
        // this.rSprite.visible = false
        this.level1Group.add(this.rSprite)
    ...
    play(){
        ...
        if(this.storylineBool){
            ...
            if(this.player.plr.x > displayWidth * 2.25){
                this.cameraPlus = 0
            }
        ...
        this.screen.x = camera.position.x
            ...
            if(this.displayGO && this.gameState == false){
                ...
                this.lSprite.mousePressed(gameOverRestart)
